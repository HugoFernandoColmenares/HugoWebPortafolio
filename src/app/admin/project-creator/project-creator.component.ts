...
export class ProjectCreatorComponent implements OnInit {
  ...
  readonly formLabels = computed<ProjectFormLabels>(() => {
    ...
    return {
      ...
      backToList: t.admin_project_back_to_list,
      sectionBasic: t.admin_project_section_basic,
      sectionMedia: t.admin_project_section_media,
      sectionLinks: t.admin_project_section_links,
      sectionSettings: t.admin_project_section_settings,
      createSubtitle: t.admin_project_form_create_subtitle,
      editSubtitle: t.admin_project_form_edit_subtitle,
      viewSubtitle: t.admin_project_form_view_subtitle,
      requiredField: t.admin_project_field_required,
      statusCompleted: t.admin_project_status_completed,
      statusInProgress: t.admin_project_status_in_progress,
      statusPlanned: t.admin_project_status_planned,
    };
