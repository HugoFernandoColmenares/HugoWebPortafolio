...
const TRANSLATIONS = {
  en: {
    ...
    hero_title: 'Full-Stack Software Engineer',
    ...
    about_bio: 'I am a passionate Full-Stack Engineer with experience in building enterprise applications using Angular, .NET Core, and SQL Server. I care about clean architecture, SOLID principles, and delivering excellent user experiences.',
    ...
    // Footer
    footer_copy: '© 2025 Hugo Fernando Colmenares. All rights reserved.',
  ...
  es: {
    ...
    hero_name: 'Hugo Colmenares',
    hero_title: 'Ingeniero de Software Full-Stack',
    ...
    about_bio: 'Soy un Ingeniero Full-Stack apasionado con experiencia en el desarrollo de aplicaciones empresariales usando Angular, .NET Core y SQL Server. Me preocupo por la arquitectura limpia, los principios SOLID y ofrecer excelentes experiencias de usuario.',
